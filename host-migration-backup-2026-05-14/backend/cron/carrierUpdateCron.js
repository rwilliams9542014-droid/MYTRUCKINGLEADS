...
export async function runDailyCarrierUpdate(options = {}) {
  ...
  try {
    ...
    console.log("[CarrierCron] Daily carrier update finished:", { motusStats, motusApprovalStats, carrierStats: stats, insuranceStats, enrichmentStats });
    return { motusStats, motusApprovalStats, carrierStats: stats, insuranceStats, enrichmentStats };
  } catch (err) {
