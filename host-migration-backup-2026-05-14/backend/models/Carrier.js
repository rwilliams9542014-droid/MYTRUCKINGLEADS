...
const carrierSchema = new mongoose.Schema(
  {
    ...
    companyOfficerTitle: { type: String, trim: true, default: "" },
    ...
    cdlDrivers: { type: Number, min: 0, default: null },
    tractorCount: { type: Number, min: 0, default: null },
    trailerCount: { type: Number, min: 0, default: null },
    straightTruckCount: { type: Number, min: 0, default: null },
    entityType: { type: String, trim: true, default: "" },
    carrierOperation: { type: String, trim: true, default: "" },
