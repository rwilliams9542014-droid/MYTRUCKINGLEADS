...
export function normalizeLeadRecord(raw = {}, type = "new_dot") {
  ...
  return {
    ...
    driverOosRate: pick(raw.driverOosRate, raw.oosRates?.driver, safety.driverOosRate, safety.oosRates?.driver, smsSafety.oosRates?.driver),
    vehicleOosRate: pick(raw.vehicleOosRate, raw.oosRates?.vehicle, safety.vehicleOosRate, safety.oosRates?.vehicle, smsSafety.oosRates?.vehicle),
