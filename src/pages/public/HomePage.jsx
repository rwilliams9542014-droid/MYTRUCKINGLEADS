      ...
      <section className="mtl-hero">
        ...
        <div className="mtl-hero-inner">
          ...
          <p className="mtl-desc">
            One focused Producer Pro plan at $149.99/month helps insurance professionals find, track, and close more trucking accounts.
          </p>
            ...
            <div className="mtl-preview-main">
              ...
              <div className="mtl-preview-cards">
                {[
                  ...
                  ["Renewal Opportunities", "42", "Next 60 days"],
