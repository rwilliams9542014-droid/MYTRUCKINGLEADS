...
const plans = [
  {
    ...
    features: [
      ...
      "5 hot lead credits/month ($10-$45 each)",
      "Email support",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "20 hot lead credits/month",
      "CSV export (5,000/mo) with selective export",
  ...
  },
  {
    ...
    features: [
      ...
      "50 hot lead credits/month + priority queue",
...
const faqs = [
  ...
  },
  {
    ...
    a: "All carrier data comes directly from the FMCSA (Federal Motor Carrier Safety Administration) database via official API access. We process and enrich this data daily.",
  },
  {
